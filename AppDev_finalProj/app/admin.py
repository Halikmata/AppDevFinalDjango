...
class GuardiansAdmin(admin.ModelAdmin):
    list_display = ['first_name', 'last_name', 'email', 'phone_number', 'is_emergency_contact', 'created_at', 'updated_at']
    search_fields = ['first_name', 'last_name', 'email', 'phone_number']

@admin.register(Student)
class StudentsAdmin(admin.ModelAdmin):
    list_display = ['first_name', 'last_name', 'date_of_birth', 'email', 'admission_date', 'guardian', 'is_active', 'created_at', 'updated_at']
    search_fields = ['first_name', 'last_name', 'email', 'phone_number']
    list_filter = ['is_active', 'admission_date']

@admin.register(Teacher)
class TeachersAdmin(admin.ModelAdmin):
    list_display = ['name', 'birthdate', 'get_subjects_taught', 'email', 'joining_date', 'is_active', 'created_at', 'updated_at']
...
class SubjectAdmin(admin.ModelAdmin):
    list_display = ['subject_name', 'code', 'prerequisite', 'units', 'lab', 'created_at', 'updated_at']
